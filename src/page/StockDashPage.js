                                        ...
                                        <form action="javascript:void(0);">
                                            <div className="row g-3 mb-0 align-items-center">
                                                ...
                                                <div className="col-auto">
                                                    <button type="button" className="btn btn-soft-success"><i className="ri-add-circle-line align-middle me-1" />
                                                        Add Product</button>
                                                </div>
                                                {/*end col*/}
                                                <div className="col-auto">
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            <div className="flex-grow-1 overflow-hidden">
                                                <p onClick={() => { setCount(count + 500); console.log("navneet", count) }} className="text-uppercase fw-medium text-muted text-truncate mb-0">
                                                    Total Earnings</p>
                                            </div>
                                        ...
                                        <div className="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 className="fs-22 fw-semibold ff-secondary mb-4">$<span className="counter-value" data-target={count}>0</span>k
                                                </h4>
                                                <a href="#" className="text-decoration-underline">View net
                                                    earnings</a>
                                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4">
                                ...
                                <div className="card card-height-100">
                                    ...
                                    {/* card body */}
                                    <div className="card-body">
                                        <div id="sales-by-locations" data-colors="[&quot;--vz-light&quot;, &quot;--vz-success&quot;, &quot;--vz-primary&quot;]" style={{ height: '269px' }} dir="ltr" />
                                            ...
                                            <table className="table table-centered table-hover align-middle table-nowrap mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 className="fs-14 mb-0">32%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" />
                                                            </h5>
                                                        </td>
                                                    </tr>{/* end */}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 className="fs-14 mb-0">79%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" />
                                                            </h5>
                                                        </td>
                                                    </tr>{/* end */}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 className="fs-14 mb-0">90%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" />
                                                            </h5>
                                                        </td>
                                                    </tr>{/* end */}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 className="fs-14 mb-0">40%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" />
                                                            </h5>
                                                        </td>
                                                    </tr>{/* end */}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 className="fs-14 mb-0">57%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" />
                                                            </h5>
                                                        </td>
                                                    </tr>{/* end */}
                                                </tbody>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <p className="text-muted lh-base">Refer a new seller to us and earn $100
                                                per refer.</p>
                                            <button type="button" className="btn btn-primary btn-label rounded-pill"><i className="ri-mail-fill label-icon align-middle rounded-pill fs-16 me-2" />
                                                Invite Now</button>
                                        </div>
                                    </div>
                                </div>
