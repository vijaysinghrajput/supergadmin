...
const CustomerManagement = () => {
    const { store_customer_list, removeDataToCurrentGlobal, getToast, reloadData } = useContext(ContextData);
            ...
            cell: (row) => {
                ...
                return (
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item onClick={() => getCustomerData(row)} data-bs-toggle="modal" data-bs-target="#UpdateProductPricing" >Make Payment</Dropdown.Item>
                            <Dropdown.Item onClick={() => getCustomerData(row)} data-bs-toggle="modal" data-bs-target="#UpdateProductPricing" >Purchase History</Dropdown.Item>
                            <Dropdown.Item onClick={() => getCustomerData(row)} data-bs-toggle="modal" data-bs-target="#UpdateProductStock" >Payment History</Dropdown.Item>
                            <Dropdown.Item onClick={() => getCustomerData(row)} data-bs-toggle="modal" data-bs-target="#UpdateCustomer" >Edit Customer</Dropdown.Item>
        ...
        fetch(URL + "/APP-API/App/deletePlot", {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.deleted) {
                    removeDataToCurrentGlobal({ type: "store_customer_list", payload: delID, where: "id" });
    ...
    return (
        <>
            ...
            <div>
                        ...
                        <div className="row g-2">
                            ...
                            <div className="col-sm-auto ms-auto">
                                <div className="list-grid-nav hstack gap-1">
                                    ...
                                    <button className="btn btn-dark" data-bs-toggle="modal" data-bs-target="#addCustomer"><i className="ri-add-fill me-1 align-bottom" /> Add Customer</button>
                                </div>
                            </div>{/*end col*/}
                        </div>{/*end row*/}
                    </div>
                    ...
                    <div className="modal-dialog modal-dialog-centered w-50">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="myModalLabel">Add Customer</h5>
                ...
                <div className="modal fade" id="UpdateCustomer" tabIndex={-1} aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered w-50">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="myModalLabel">Edit Customer</h5>
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
                            </div>
                            <div className="modal-body">
