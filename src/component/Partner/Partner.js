  ...
  const STORY_HEADERS_SLOTS = [
    {
      ...
      cell: (row) => {
        return (
          <p>
            {" "}
            {(Number(row.slot_time_start) > 12
              ? Number(row.slot_time_start) - 12
              : Number(row.slot_time_start)) +
              " " +
              row.start_time_postfix +
              " To " +
              (Number(row.slot_time_end) > 12
                ? Number(row.slot_time_end) - 12
                : Number(row.slot_time_end)) +
              " " +
              row.end_time_postfix +
              " - " +
              row.slot_name +
              " Delivery"}{" "}
          </p>
              ...
              >
                ...
                <li className="nav-item">
                  ...
                  >
                    ...
                    <span className="d-none d-md-inline-block">Address</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a
                  ...
                  >
                    ...
                    <span className="d-none d-md-inline-block">Contact</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a
                          ...
                          <div className="col-1 col-md-1">
                            <div className="d-flex mt-4">
                              <div className="flex-shrink-0 avatar-xs align-self-center me-3">
                                <div className="avatar-title bg-light rounded-circle fs-16 text-primary">
                                  <a
                                    href={showDataBusiness?.facebook}
                                    target="_blank"
                                  >
                                    {" "}
                                    <FaFacebookF />
                          ...
                          <div className="col-1 col-md-1">
                            <div className="d-flex mt-4">
                              <div className="flex-shrink-0 avatar-xs align-self-center me-3">
                                <div className="avatar-title bg-light rounded-circle fs-16 text-primary">
                                  <a
                                    href={showDataBusiness?.instagram}
                                    target="_blank"
                                  >
                                    {" "}
                                    <AiOutlineInstagram />
                          ...
                          <div className="col-1 col-md-1">
                            <div className="d-flex mt-4">
                              <div className="flex-shrink-0 avatar-xs align-self-center me-3">
                                <div className="avatar-title bg-light rounded-circle fs-16 text-primary">
                                  <a
                                    href={showDataBusiness?.linkedin}
                                    target="_blank"
                                  >
                                    {" "}
                                    <FaLinkedinIn />
                          ...
                          <div className="col-1 col-md-1">
                            <div className="d-flex mt-4">
                              <div className="flex-shrink-0 avatar-xs align-self-center me-3">
                                <div className="avatar-title bg-light rounded-circle fs-16 text-primary">
                                  <a
                                    href={showDataBusiness?.google_map_link}
                                    target="_blank"
                                  >
                                    {" "}
                                    <FaMapMarkedAlt />
                    ...
                    <div className="col-sm-auto ms-auto">
                      <div className="list-grid-nav hstack gap-1">
                        <button
                          ...
                          data-bs-target="#importdeliveryarea"
                        >
                        ...
                        <button
                          ...
                          data-bs-toggle="modal"
                          data-bs-target="#importdeliveryslot"
                        >
                          <i className="ri-add-fill me-1 align-bottom" /> ADD
                          Delivery Slot
                        </button>
                      ...
                      <div className="col-4 col-md-4">
                        <div className="d-flex mt-4">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            ...
                            <a href="#" className="fw-semibold">
                              ₹ {showDataBusiness?.minimum_order}
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-6 col-md-4">
                        <div className="d-flex mt-4">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            ...
                            <a href="#" className="fw-semibold">
                              {showDataBusiness?.carry_bag_charge_minimum_qty}
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-6 col-md-4">
                        <div className="d-flex mt-4">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            ...
                            <a href="#" className="fw-semibold">
                              ₹ {showDataBusiness?.carry_bag_charge}
                            </a>
                          </div>
                        </div>
                      </div>
              ...
              >
                <div className="modal-dialog modal-dialog-centered w-50">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">{/* <ImportNewArea /> */}</div>
                  </div>
                  {/*end modal-content*/}
                </div>
                {/*end modal-dialog*/}
