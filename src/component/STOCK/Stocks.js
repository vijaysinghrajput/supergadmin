...
const Stocks = () => {
  const { storeProductsData, removeDataToCurrentGlobal, getToast, reloadData } =
    ...
    () => [
      {
        ...
        isSortable: true,
        cell: (row) => {
          return <p className="text-dark">{row.product_name}</p>;
        },
      },
      {
        prop: "image",
      ...
      },
      {
        ...
        cell: (row) => {
          if (Number(row.stock_quantity) < Number(row.stock_alert_quantity)) {
            return <p className="text-danger">{row.stock_quantity}</p>;
          } else {
            return <p className="text-success">{row.stock_quantity}</p>;
          }
        },
      },
      {
        ...
        cell: (row) => {
          if (
            Number(row.stok_warehouse_qty) <
            Number(row.warehouse_stock_alert_quantity)
          ) {
            return <p className="text-danger">{row.stok_warehouse_qty}</p>;
          } else {
            return <p className="text-success">{row.stok_warehouse_qty}</p>;
          }
        },
      },

      {
        ...
        isSortable: true,
        cell: (row) => {
          return <p className="text-dark">{row.stock_alert_quantity}</p>;
        },
      },
      {
...

      {
        ...
        isSortable: true,
        cell: (row) => {
          return <p className="text-dark"> ₹ {row.sale_price}</p>;
        },
      },
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                <Dropdown.Item
                  ...
                  data-bs-target="#warehousetostore"
                >
                  {" "}
                  Warehouse To Store
                </Dropdown.Item>
                <Dropdown.Item
                  onClick={() => setUpdateProductPrice(row)}
                  data-bs-toggle="modal"
                  data-bs-target="#storetowarehouse"
                >
                  {" "}
                  Store To Warehouse
                </Dropdown.Item>
