...
export const UpdateEmployee = (EditVendorData) => {
  const {
    storeCategoryData,
    storeBrandsData,
    storeProductUnits,
  ...
  const UpdateProductAction = () => {
    if (vendorDetails.name == "") {
      getToast({
        title: "Vendor Contact Name Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.mobile == "") {
      getToast({
        title: "Vendor Contact Mobile Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.contact_roal == "") {
      getToast({
        title: "Vendor Contact Roal Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.firm_name == "") {
      getToast({
        title: "Firm Name  Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.address == "") {
      getToast({
        title: "Vendor Address Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.city == "") {
      getToast({
        title: "Vendor City Requird",
        dec: "Requird",
        status: "error",
      });
    } else if (vendorDetails.pin_code == "") {
      getToast({
        title: "Vendor Pincode Requird",
        dec: "Requird",
        status: "error",
      });
    } else {
  ...
  const setDiscount = (value) => {
    let dicountPerc =
      ((vendorDetails.price - vendorDetails.sale_price) / vendorDetails.price) *
      10;

    setvendorDetails({
      ...vendorDetails,
      discount_in_rs: value,
      sale_price: vendorDetails.price - value,
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              type="text"
              onChange={(e) =>
                setvendorDetails({ ...vendorDetails, mobile: e.target.value })
              }
          ...
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(e) =>
                setvendorDetails({
                  ...vendorDetails,
                  contact_roal: e.target.value,
                })
              }
              value={vendorDetails.contact_roal}
              className="form-control"
              placeholder="Contact Roal"
              id="compnayNameinput"
            />
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              ...
              value={vendorDetails.firm_email}
              className="form-control"
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              type="text"
              onChange={(e) =>
                setvendorDetails({ ...vendorDetails, gst_no: e.target.value })
              }
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              type="text"
              onChange={(e) =>
                setvendorDetails({ ...vendorDetails, fssai_no: e.target.value })
              }
              value={vendorDetails.fssai_no}
              className="form-control"
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              type="text"
              onChange={(e) =>
                setvendorDetails({ ...vendorDetails, city: e.target.value })
              }
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              type="text"
              onChange={(e) =>
                setvendorDetails({ ...vendorDetails, pin_code: e.target.value })
              }
              value={vendorDetails.pin_code}
              className="form-control"
              placeholder="Pincode"
              id="compnayNameinput"
            />
