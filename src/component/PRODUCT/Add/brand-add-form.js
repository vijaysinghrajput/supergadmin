...
export const AddBrandForm = (props) => {
  const { addDataToCurrentGlobal, getToast, reloadData } =
  ...
  const AddPlot = () => {
    if (
      storeBrandsData.brand_name == null &&
      storeBrandsData.brand_feature_image == null
    ) {
      getToast({
        title: "Brand Name & Image Requird",
        dec: "Requird",
        status: "error",
      });
    } else {
      ...
      storeBrandsData.brand_feature_image &&
        storeBrandsData.brand_feature_image.map((item, i) => {
        ...
        <div className="col-md-6">
          <div className="mb-3">
            ...
            <input
              ...
              value={storeBrandsData.brand_name}
          ...
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(e) =>
                setstoreBrandsData({
                  ...storeBrandsData,
                  brand_feature_image: [...e.target.files],
                })
              }
              className="form-control"
