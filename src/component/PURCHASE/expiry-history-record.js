...
const ExpiryHistoryRecord = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      await fetch(URLDomain + "/APP-API/Billing/expiry_history_record", {
        method: "post",
        header: {
      ...
      <div className="row">
        <div className="col-12">
          <div className="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 className="mb-sm-0">Expiry</h4>
          </div>
        </div>
      </div>
      <div className="row">
                        ...
                        >
                          ...
                          <div className="d-flex py-3 px-5 justify-content-between align-items-center border-bottom">
                            ...
                            <Flex
                              ...
                              alignItems={"center"}
                            >
                              {store_vendor_purchase_record_data.settlement_status ==
                              0
                                ? "Not Settlement"
                                : "Settlement"}
                            </Flex>
                          ...
                          <div className="d-flex py-3 px-5 justify-content-between align-items-center border-bottom">
                            ...
                            >
                              {
                                store_vendor_purchase_record_data.settlement_date
                              }
                            </Flex>
                          </div>
...
export default ExpiryHistoryRecord;
