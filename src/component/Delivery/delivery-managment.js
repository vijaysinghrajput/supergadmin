...
// import { AddVendorForm } from "./Add/delivery-boy-add-form";
...
// import { UpdateVendor } from "./Update/UpdateDeliveryPersone";
                    ...
                    <div className="card-body">
                        <div className="row g-2"> 
                            ...
                            <div className="col-sm-auto ms-auto">
                                ...
                                <Link to="/delivery-boy" >    <button className="btn btn-primary" > Delivery Boy</button>
 </Link>
